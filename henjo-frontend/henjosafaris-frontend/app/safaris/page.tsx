...
import { FaMapMarkerAlt, FaClock, FaSearch, FaFilter, FaTimes } from 'react-icons/fa';
    ...
    useEffect(() => {
        const fetchPackages = async () => {
            try {
                ...
                console.log('📡 Fetching packages with parameters:', params);
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-3 md:gap-4 items-center">
                        ...
                        <div className="relative">
                            ...
                            >
                                <span className={filters.country ? 'font-bold text-[var(--brand-gold)]' : ''}>
                                    📍 {getFilterLabel('country', filters.country)}
                                </span>
                            ...
                            {activeDropdown === 'country' && (
                                <div className="absolute left-0 mt-2 w-56 rounded-2xl shadow-lg border p-2 z-50 bg-[#152018] border-[#2A3E2E]">
                                    ...
                                    {options.countries.map((c) => (
                                        ...
                                        >
                                            <span>{c.name}</span>
                                            {filters.country === c.name && <span className="text-[var(--brand-gold)]">✓</span>}
                                        </button>
                                    ))}
                                </div>
                            )}
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="w-full px-4 py-3 rounded-2xl text-left text-sm text-white bg-black/35 focus:bg-black/50 border border-white/10 hover:border-white/30 transition-colors flex justify-between items-center"
                            >
                                <span className={filters.category ? 'font-bold text-[var(--brand-gold)]' : ''}>
                            ...
                            {activeDropdown === 'category' && (
                                <div className="absolute left-0 mt-2 w-56 rounded-2xl shadow-lg border p-2 z-50 bg-[#152018] border-[#2A3E2E]">
                                    ...
                                    {options.categories.map((c: any) => (
                                        ...
                                        >
                                            <span>{c.name}</span>
                                            {filters.category === c.slug && <span className="text-[var(--brand-gold)]">✓</span>}
                                        </button>
                                    ))}
                                </div>
                            )}
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="w-full px-4 py-3 rounded-2xl text-left text-sm text-white bg-black/35 focus:bg-black/50 border border-white/10 hover:border-white/30 transition-colors flex justify-between items-center"
                            >
                                <span className={filters.destination ? 'font-bold text-[var(--brand-gold)]' : ''}>
                                    🏔️ {getFilterLabel('destination', filters.destination)}
                                </span>
                                <span className="text-white/60">▼</span>
                            </button>
                            {activeDropdown === 'destination' && (
                                <div className="absolute left-0 mt-2 w-56 rounded-2xl shadow-lg border p-2 z-50 bg-[#152018] border-[#2A3E2E]">
                                    ...
                                    {options.destinations.map((d: any) => (
                                        ...
                                        >
                                            <span>{d.name}</span>
                                            {filters.destination === d.slug && <span className="text-[var(--brand-gold)]">✓</span>}
                                        </button>
                                    ))}
                                </div>
                            )}
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="w-full px-4 py-3 rounded-2xl text-left text-sm text-white bg-black/35 focus:bg-black/50 border border-white/10 hover:border-white/30 transition-colors flex justify-between items-center"
                            >
                                <span className={filters.activity ? 'font-bold text-[var(--brand-gold)]' : ''}>
                                    🛶 {getFilterLabel('activity', filters.activity)}
                                </span>
                                <span className="text-white/60">▼</span>
                            </button>
                            {activeDropdown === 'activity' && (
                                <div className="absolute left-0 mt-2 w-56 rounded-2xl shadow-lg border p-2 z-50 bg-[#152018] border-[#2A3E2E]">
                                    ...
                                    {options.activities.map((a: any) => (
                                        ...
                                        >
                                            <span>{a.name}</span>
                                            {filters.activity === a.slug && <span className="text-[var(--brand-gold)]">✓</span>}
                                        </button>
                                    ))}
                                </div>
                            )}
            ...
            <div className="py-20 transition-colors duration-300">
                <div className="container mx-auto px-4">
                    {loading ? (
                        ...
                        >
                            <p className="font-semibold text-lg" style={{ color: 'var(--brand-maroon)' }}>❌ Error Loading Safaris</p>
